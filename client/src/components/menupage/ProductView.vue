<template>
    <Teleport to="body">
        ...
        <Transition enter-active-class="transition duration-300 ease-out" enter-from-class="opacity-0"
            ...
            <div v-if="isOpen"
                class="fixed inset-0 z-9999 flex items-center justify-center p-4 h-full w-full font-sans">

                <div class="absolute inset-0 bg-[radial-gradient(circle_at_center,var(--tw-gradient-stops))] from-black/30 via-black/60 to-black/80 backdrop-blur-sm"
                ...
                <Transition appear enter-active-class="transition duration-300 ease-out delay-75"
                    ...
                    <div
                        ...
                        <div
                            class="w-full md:w-[45%] bg-stone-200 relative h-60 sm:h-72 md:h-auto md:min-h-full shrink-0">
                            <transition name="fade" mode="out-in">
                                <img :key="currentImageIndex" :src="product?.images[currentImageIndex]"
                                    :alt="product?.title" class="w-full h-full object-cover absolute inset-0" />
                            </transition>
                        ...
                        <div class="w-full md:w-[55%] flex flex-col h-full overflow-hidden">
                            ...
                            <div class="p-5 sm:p-8 md:p-10 overflow-y-auto custom-scrollbar flex-1">
                                ...
                                <div class="mb-4 md:mb-6">
                                    <div class="flex flex-col sm:flex-row sm:items-start justify-between gap-2 mb-2">
                                        <h2
                                            class="text-2xl md:text-4xl font-serif font-bold text-stone-900 leading-tight pr-8 md:pr-0">
                                            {{ product?.title }}
                                        </h2>
                            ...
                            <div
                                class="p-4 sm:p-6 md:p-8 bg-white/60 backdrop-blur-md border-t border-stone-200/60 shrink-0 z-10">
